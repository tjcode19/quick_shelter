...
class PropertyDetailsP extends StatefulWidget {
  final propertyDetails;
  const PropertyDetailsP({Key key, this.propertyDetails}) : super(key: key);

  @override
  _PropertyDetailsPState createState() => _PropertyDetailsPState();
}

class _PropertyDetailsPState extends State<PropertyDetailsP> {
                        ...
                        child: Text(
                          (_propertyDetails.property.title != null)
                              ? (_propertyDetails.property.title.length > 50)
                                  ? '${_propertyDetails.property.title.substring(0, 50)} ...'
