...
class SearchResultPub extends StatefulWidget {
  final propertyList;
  const SearchResultPub({Key key, this.propertyList}) : super(key: key);

  @override
  _SearchResultPubState createState() => _SearchResultPubState();
}

class _SearchResultPubState extends State<SearchResultPub> {

List<PropLandingData> searchedPropList;  
