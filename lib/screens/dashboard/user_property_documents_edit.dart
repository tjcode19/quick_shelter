...
class UserPropDocEdit extends StatefulWidget {
  final propertyData;

  const UserPropDocEdit({Key key, this.propertyData}) : super(key: key);

  @override
  _UserPropDocEditState createState() => _UserPropDocEditState();
}

class _UserPropDocEditState extends State<UserPropDocEdit> {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                  ...
                  child: Text(
                    'You have successfully updated your property documents.',
