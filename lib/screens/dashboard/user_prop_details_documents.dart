...
class UserPropDetailsDoc extends StatefulWidget {
  final propDetails;

  UserPropDetailsDoc({Key key, this.propDetails}) : super(key: key);
  @override
  _UserPropDetailsDocState createState() => _UserPropDetailsDocState();
}

class _UserPropDetailsDocState extends State<UserPropDetailsDoc> {
  GetUserPropData _propertyDet;

  List<PropDocData> _propDoc = List();
  ...
  void _getPropertyDocs() {
    var _apiCall = repo.getPropertyDocuments(_propertyDet.iD.toString());
    ...
    return Scaffold(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: GridView.count(
                    ...
                    children:
                        List.generate(_propDoc.length, (index) {
                      return Center(
                        child:
                            // Text(
                            //   'Item $index',
      ...
      floatingActionButton: AnimatedOpacity(
        ...
        child: FloatingActionButton.extended(
          onPressed: () {
            Navigator.pushNamed(context, userPropDocEditRoute, arguments: {
              'propID': _propertyDet.iD,
              'type': 'editProp',
                        ...
                        GestureDetector(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Text(_propDoc[index].name,
                              softWrap: true,
                                  style: TextStyle(
                                      color: Colors.black87, fontSize: 10.0)),
                            ],
                          ),
                        ),
                        // Row(
          ...
          children: <Widget>[
            Text(
              (_propertyDet.title.length > 15)
                  ? '${_propDoc[index].name.substring(0, 15)}...'
                  : _propDoc[index].name,
